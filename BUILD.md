...
```
# Build the Docker image
docker build --no-cache --pull --tag nicoherbigde/atlassian-confluence-server:7.19-jammy 7.19/ubuntu/default
```
...
docker push nicoherbigde/atlassian-confluence-server:7.19-jammy
```
